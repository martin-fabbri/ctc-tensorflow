...
class DataLoader(object):
    ...
    # graph regions
    def _prepare_minibatch(self, audio_paths, texts, sess, mfcc, wav_file_placeholder):
    ...
    def _iterate(self, audio_paths, texts, minibatch_size, sess):
    ...
    def next_training_batch(self, sess):
        ...
        return self._iterate(audio_paths, texts, self.train.minibatch_size, sess)
